...
})(SoftHandlerEvent || (SoftHandlerEvent = {}));
...
class MsgProcess {
  ...
  onMessage(msg, jsep) {
    ...
    if (msgErrCode) {
      ...
      this.handler.listener.dispatch(SoftHandlerEvent.ERROR, {
        code: msgErrCode,
        message: errorMsg
      });
      return false;
  ...
  ringing(message) {
    // MSG_CALLBACK.ringFile(true, _self._opts.configs.ringFile);
    var callId = message.call_id;
    this.handler.listener.dispatch(SoftHandlerEvent.RINGING, {
      callId: callId
    });
  ...
  accepted(message, jsep) {
    ...
    this.handler.listener.dispatch(SoftHandlerEvent.ACCEPTED, {
      callId: callId,
      telNumber: telNumber
    });
  ...
  hangup(message) {
    ...
    this.handler.listener.dispatch(SoftHandlerEvent.HANGUP, {
      callId: callId,
  ...
  hangupResult(message) {
    ...
    var result = message.result;
    this.handler.callId = null;
    this.handler.listener.dispatch(SoftHandlerEvent.HANGUP_RESULT, {
      callId: callId,
      code: result === null || result === void 0 ? void 0 : result.code,
      reason: result === null || result === void 0 ? void 0 : result.reason
    });
  ...
  registerResult(message, type) {
    ...
    if (type == 'succ') {
      ...
      this.handler.listener.dispatch(SoftHandlerEvent.REG_RESULT, {
        event: "succ",
        telNumber: telNumber
      });
      console.log("注册成功通知");
  ...
  unregisterResult(message) {
    ...
    var telNumber = result === null || result === void 0 ? void 0 : result.username;
    this.handler.username = null;
    this.handler.listener.dispatch(SoftHandlerEvent.UNREG_RESULT, {
      event: event,
      telNumber: telNumber
    });
    console.log("注销结果通知");
  ...
  callingResult(message) {
    var callId = message.call_id;
    this.handler.listener.dispatch(SoftHandlerEvent.CALL_RESULT, {
      callId: callId
    });
  }
  ...
  answerResult(message) {
    ...
    var callId = message.call_id;
    this.handler.callId = callId;
    this.handler.listener.dispatch(SoftHandlerEvent.ANSWER_RESULT, {
      callId: callId
    });
  }
...
export { SoftHandlerEvent, createSoftHandler, listMediaDevices };
